...
<head>
    <meta charset="utf-8">
    <title>Güvenli Tarım - İletşim</title>
    ...
    <nav class="navbar navbar-expand-lg bg-primary navbar-dark shadow-sm py-3 py-lg-0 px-3 px-lg-5">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav mx-auto py-0">
                ...
                <a href="contact.php" class="nav-item nav-link active">İLETİŞİM</a>
                <?php
                    session_start();
                    ob_start();
                    include 'db_con.php';
        ...
        <div class="container py-5">
            <div class="row justify-content-start">
                <div class="col-lg-8 text-center text-lg-start">
                    <h1 class="display-1 text-white mb-md-4">İletişim</h1>
                    <a href="" class="btn btn-primary py-md-3 px-md-5 me-3">Anasayfa</a>
                    <a href="" class="btn btn-secondary py-md-3 px-md-5">İletişim</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid py-5">
        <div class="container">
            <div class="mx-auto text-center mb-5" style="max-width: 500px;">
                ...
                <h1 class="display-5">Bizimle iletişime geçmeye çekinmeyin !</h1>
            </div>
            <div class="row g-0">
                <div class="col-lg-7">
                    <div class="bg-primary h-100 p-5">
                        <form>
                            <div class="row g-3">
                                <div class="col-6">
                                    <input type="text" class="form-control bg-light border-0 px-4" placeholder="Adınız" style="height: 55px;">
                                </div>
                                <div class="col-6">
                                    <input type="email" class="form-control bg-light border-0 px-4" placeholder="Epostanız" style="height: 55px;">
                                </div>
                                <div class="col-12">
                                    <input type="text" class="form-control bg-light border-0 px-4" placeholder="Konu" style="height: 55px;">
                                </div>
                                <div class="col-12">
                                    <textarea class="form-control bg-light border-0 px-4 py-3" rows="2" placeholder="Mesajınız"></textarea>
                                </div>
                                <div class="col-12">
                                    <button class="btn btn-secondary w-100 py-3" type="submit">Mesaj Gönder</button>
                                </div>
                            </div>
                        </form>
                    </div>
                ...
                <div class="col-lg-5">
                    <div class="bg-secondary h-100 p-5">
                        <h2 class="text-white mb-4">Detaylı İletişim İçin...</h2>
                        <div class="d-flex mb-4">
                            <div class="bg-primary rounded-circle d-flex align-items-center justify-content-center" style="width: 60px; height: 60px;">
                                <i class="bi bi-geo-alt fs-4 text-white"></i>
                            </div>
                            <div class="ps-3">
                                <h5 class="text-white">Ofisimiz</h5>
                                <span class="text-white">Kayali, Kırklareli, TÜRKİYE</span>
                            </div>
                        </div>
                        <div class="d-flex mb-4">
                            <div class="bg-primary rounded-circle d-flex align-items-center justify-content-center" style="width: 60px; height: 60px;">
                            ...
                            <div class="ps-3">
                                <h5 class="text-white">Emailimiz</h5>
                                <span class="text-white">bilgi@gunvenlitarim.net</span>
                            </div>
                        </div>
                        <div class="d-flex">
                            <div class="bg-primary rounded-circle d-flex align-items-center justify-content-center" style="width: 60px; height: 60px;">
                            ...
                            <div class="ps-3">
                                <h5 class="text-white">Telefonumuz</h5>
