...
<head>
    <meta charset="utf-8">
    <title>Güvenli Tarım - Hakkımızda</title>
    ...
    <nav class="navbar navbar-expand-lg bg-primary navbar-dark shadow-sm py-3 py-lg-0 px-3 px-lg-5">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav mx-auto py-0">
                ...
                <a href="about.php" class="nav-item nav-link active">HAKKIMIZDA</a>
        ...
        <div class="container py-5">
            <div class="row justify-content-start">
                <div class="col-lg-8 text-center text-lg-start">
                    <h1 class="display-1 text-white mb-md-4">Hakkımızda</h1>
                    <a href="index.php" class="btn btn-primary py-md-3 px-md-5 me-3">Anasayfa</a>
                    <a href="about.php" class="btn btn-secondary py-md-3 px-md-5">Hakkımızda</a>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row gx-5">
                ...
                <div class="col-lg-6 pb-5">
                    <div class="mb-3 pb-2">
                        ...
                        <h1 class="display-5">Çiftçilerimizi Bilinçlendirmeye Çalışıyoruz</h1>
                    </div>
                    <p class="mb-4">Biraz gerçekçi olursak eğer, modern tarım konusunda dünyadan oldukça geride kaldık. Çiftçimizi geliştirecek modern tarımın ilk adımlarını bu projeyle başlatıyoruz.</p>
                    <div class="row gx-5 gy-4">
                        <div class="col-sm-6">
                            <i class="fa fa-seedling display-1 text-secondary"></i>
                            <h4>100% Doğal</h4>
                            <p class="mb-0">Etkili doğal gübrelerin kullanılması önceliğimiz.</p>
                        </div>
                        <div class="col-sm-6">
                            <i class="fa fa-award display-1 text-secondary"></i>
                            <h4>Kaliteli Ekin</h4>
                            <p class="mb-0">Hava şartlarının takibiyle ekin kalitesini arttırmak önceliğimiz.</p>
                        </div>
                    </div>
                </div>
            </div>
