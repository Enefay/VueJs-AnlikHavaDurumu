...
<head>
    <meta charset="utf-8">
    <title>Güvenli Tarım - Giriş Yap</title>
        ...
        <div class="container py-5">
            <div class="row justify-content-start">
                <div class="col-lg-8 text-center text-lg-start">
                    <h1 class="display-1 text-white mb-md-4">Giriş Yap</h1>
                    <a href="" class="btn btn-primary py-md-3 px-md-5 me-3">Anasayfa</a>
                    <a href="" class="btn btn-secondary py-md-3 px-md-5">Giriş Yap</a>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row g-0">
                <div class="col-lg-7">
                    <div class="bg-primary h-100 p-5">
                        <form method="POST" action="session.php">
                            <div class="row g-3">
                                <div class="col-12">
                                    <input type="text" class="form-control bg-light border-0 px-4" placeholder="E-posta" style="height: 55px;" name="email">
                                </div>
                                <div class="col-12">
                                    <input type="password" class="form-control bg-light border-0 px-4" placeholder="Şifre" style="height: 55px;" name="sifre">
                                </div>
                                <div class="col-12">
                                   <a href="#"><button class="btn btn-secondary w-100 py-3" type="submit" name="buton">Giriş Yap</button></a> 
                                </div>
                            </div>
                        </form>
                    </div>
                ...
                <div class="col-lg-5">
                    <div class="bg-secondary h-100 p-5">
                        <h2 class="text-white mb-4">Üye Değil Misin ?</h2>
                        <div class="d-flex mb-4">

                        </div>
                        <div class="d-flex mb-4">
                            <a class="btn btn-primary w-100 py-3"" href="register.php" role="button">Kayıt Ol</a>
                        </div>
                        <div class="d-flex">
